...
# start calulcation
gray_image = cv2.imread('img4.jpg', 0)
...
blur = cv2.GaussianBlur(gray_image, (75,75), 0)
sub = cv2.subtract(blur,gray_image)
...
cv2.imshow('Image with bounding boxes', gray_image)
cv2.waitKey()
